    ...
    return (
        <div>
            ...
            <div className='footer text-light bg-dark pb-3 px-2'>
                    ...
                    <Col>
                        <Card.Body>
                            ...
                            <Card.Text>
                                ...
                                <p> <a href="/">http://www.booking.LTD.com/</a></p>
                                <p> <a href="/">info@resort.com</a></p>
                                <p>031-656565</p>
                                <div>
                ...
                <hr />
            <p> <small className='text-light'>Resort Booking Travel Agency &copy; 2022 | All Rights Reserved</small> </p>
            <p><small>Developed By Resort@Booking.LTD</small></p>
            </div>
        </div>
        </div>
    );
